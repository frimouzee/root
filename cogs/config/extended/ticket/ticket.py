...
from core import FlagConverter, Context as OriginalContext
...
from utils.conversions.discord import StrictRole, TouchableMember
from managers.parser import Script, parse
from utils.tools.formatter import codeblock, vowel
