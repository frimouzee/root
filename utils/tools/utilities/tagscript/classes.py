...
class Tag:
    """
    Represents a tag that has been decorated
    with @Parser.tag or @tagformatter.tag.
    """

    def __init__(
        self, parser, callback, name, description, aliases, *, parent=None, **attrs
    ):
        self._tags = []
        self._parser = parser
    ...
    def tag(
        self, name: str = None, *, alias: str = None, aliases: list[str] = None, **attrs
    ):
        if not aliases:
